...
class GroupViewTest(TestCase):
    ...
    def setUp(self):
        ...
        self.edit_groups_permission, _ = Permission.objects.get_or_create(
            name="edit_groups"
        )
        self.view_groups_permission, _ = Permission.objects.get_or_create(
            name="view_groups"
        )
        self.delete_groups_permission, _ = Permission.objects.get_or_create(
            name="delete_groups"
        )
    ...
    def test_group_create_view(self):
        ...
        response = self.client.post(
            reverse("group_add"), {"name": "New Group", "members": [self.admin_user.id]}
        )
    ...
    def test_group_edit_view(self):
        ...
        response = self.client.post(
            reverse("group_edit", args=[group.id]),
