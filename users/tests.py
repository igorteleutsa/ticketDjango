...
class UserViewTest(TestCase):
    ...
    def setUp(self):
        ...
        self.edit_users_permission, _ = Permission.objects.get_or_create(name='edit_users')
        self.view_users_permission, _ = Permission.objects.get_or_create(name='view_users')
        self.delete_users_permission, _ = Permission.objects.get_or_create(name='delete_users')
    ...
    def test_user_list_view(self):
        self.client.login(email=self.admin_user.email, password='complex_password123')
        User.objects.create_user(email='user1@example.com', password='complex_password123')
        User.objects.create_user(email='user2@example.com', password='complex_password123')
    ...
    def test_user_detail_view(self):
        self.client.login(email=self.admin_user.email, password='complex_password123')
        user = User.objects.create_user(email='userdetail@example.com', password='complex_password123')
    ...
    def test_user_edit_view(self):
        self.client.login(email=self.admin_user.email, password='complex_password123')
        user = User.objects.create_user(email='edituser@example.com', password='complex_password123')
    ...
    def test_user_delete_view(self):
        self.client.login(email=self.admin_user.email, password='complex_password123')
        user = User.objects.create_user(email='deleteuser@example.com', password='complex_password123')
